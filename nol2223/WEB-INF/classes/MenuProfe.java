...
/**
 * Servlet implementation class MenuProfe
 */
public class MenuProfe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     // TIPO DE CONTENIDO
        ...
        String dir = "http://" + milogin + ":9090/CentroEducativo/profesores/" + user + "?key=" + key;
        ...
        out.println("            <h1 class='display-4' style='color: white'>Men&uacute; de Profesor</h1>");
        out.println(
                "            <h2 class='lead my-3' style='color: white'>Esta p&aacute;gina muestra el menu inicial de ");
        out.println(                nombre + " " + apellidos + " .</h2>");
        out.println("        </div>");
        out.println("    </div>");
        out.println("    <div class='container'>");
