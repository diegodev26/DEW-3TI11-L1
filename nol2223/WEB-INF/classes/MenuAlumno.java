...
public class MenuAlumno extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // USAMOS JSONARRAY PARA PODER DESPLEGAR LA LISTA DE APLICACIONES
        	...
        	out.println("<div class='card flex-column'>");
            out.println("    <h5 class='card-header'>Generar Certificado Acad&eacute;mico</h5>");
            out.println("    <div class='card-body'>");
            out.println("        <form action='Certificado2' method='GET'>");
            ...
            out.println("            <button type='submit' class='btn btn-link'>Generar</button>");
            out.println("        </form>");
            out.println("    </div>");
            out.println("</div>");
        	out.println("</div>");
