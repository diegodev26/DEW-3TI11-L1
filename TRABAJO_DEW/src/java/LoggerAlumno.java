...
public class LoggerAlumno extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // EXTRAEMOS Y GUARDAMOS EL ESCRITOR DE RESPONSE PARA POSTERIORMENTE FACILITAR
        // LOS PRINTS
        PrintWriter out = response.getWriter();

        // OBTENEMOS EL DNI Y KEU OBTENIDOS TRAS EJECUTAR EL FILTRO DE AUTENTICACION
        // TRAS EL LOGIN DE DNI Y KEY
