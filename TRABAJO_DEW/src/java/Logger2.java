...
public class Logger2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// CREACION DEL ARCHIVO DE TEXTO USANDO EL PARAMETRO DEL SERVLET LOGPATH Y
		// CONTROL DE FALLO DE CREACION(ESTANDAR)
		...
		// INICIALIZAMOS EL PRINT EN PANTALLA CON UBICACIÓN DE ESCRITURA EN EL PARAMETRO
		// LOGPATH
